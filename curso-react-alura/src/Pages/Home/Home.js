...
class Home extends Component {
  ...
  render() {
    ...
    const campos = [
      {titulo:'Autores', nomeCampo: 'nome'},
      {titulo:'Livros', nomeCampo: 'livro'},
      {titulo:'Preços', nomeCampo: 'preco'},
    ];
    ...
    return (
      <Fragment>
        ...
        <Tabela dados={this.state.autores} removeDados={this.removeAutor} campos = {campos} />
        </div>
      </Fragment>
    );
  }
